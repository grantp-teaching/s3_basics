...
% \subsection{Ec2 to S3}

% Use the setup file \url{s3_setup.ps1}.

% By following the steps in \autoref{sec:ec2-access-to-s3}, create a new EC2 instance that can directly access your S3 bucket(s) using the aws command without setting ID/key.
